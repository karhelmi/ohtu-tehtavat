...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostosten_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_sama_tuoteostosten_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_on_toinen_tuote_ei_ole_ostosten_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_nollaa_edellisen_ostoksen_tiedot(self):
        ...
        pankki_mock.tilisiirto.assert_called_with("maija",42,"54321","33333-44455",0)
    ...
    def test_poista_korista_poistaa_ostoskorista(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
